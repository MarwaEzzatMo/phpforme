    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            ...
            <div class="card">
                ...
                <form class="form-card" onsubmit="event.preventDefault()">
                   ...
                   <div class="form-group col-sm-6 flex-column d-flex"> <label name="first_name" class="form-control-label px-3">First name<span class="text-danger"> * 	
					...
					?> </span></label> <input type="text" id="mob" name="phone" placeholder="" onblur="validate(4)" value="<?php if(isset($olddata->phone)) {echo $olddata->phone;} ?>" > </div>
                    </div>  
                    <div class="row justify-content-between text-left">
            ...
            <div class=" row form-group">
                ...
                <div class="col-sm-9">
                ...
                </label> <input  type="text" id="job" name="username" placeholder="" onblur="validate(5)" value="<?php if(isset($olddata->username)) {echo $olddata->username;} ?>"> </div>
					...
					?></span></label> <input type="password" id="ans" name="password" placeholder="" onblur="validate(6)"> </div>
                    </div>
                    <div class="row justify-content-between text-left">
						...
						if(isset($errors->department)){
							echo "<span style='color:red'> $errors->department </span>";
							
						}
					?></span></label> <input type="text" id="job" name="department" placeholder="" onblur="validate(5)" value="<?php if(isset($olddata->department)) {echo $olddata->department;} ?>"> </div>
